...
## 📌 最新仕様書
- 主仕様書: [SPEC_v20260415.md](SPEC_v20260415.md) （2026-04-15 最新版）
- 直近パッチ: [PATCH_006.md](PATCH_006.md) （2026-04-01 最新版）
- ※ `SPEC_v3.md` や `PATCH_003.md`〜`PATCH_005.md` などの古いファイルは旧版／マージ済みです。
